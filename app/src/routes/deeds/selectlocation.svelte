<script>
    ...
    let addressValue = "", latitude = "", longitude = "";
...
<NavBar on:leftClick={() => history.back()} leftProps={backProps}> </NavBar>
<div id="content-container">
    ...
    <Map id="map" bind:this={mapComponent} on:mapClick={handleMapClick}> </Map>
</div>
<div id="save">
