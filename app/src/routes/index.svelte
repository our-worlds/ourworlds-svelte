<script>
    ...
    let firstTime = !localStorage.getItem(firstTimeToken) || localStorage.getItem(firstTimeToken) === 'false';
...
<section>
    ...
    <div id="actions">
        ...
        {/if}
        {#if firstTime}
            <button id="firststart" class:firstTime on:click={() => goto('/wizards/intro')}>Introduction</button>
