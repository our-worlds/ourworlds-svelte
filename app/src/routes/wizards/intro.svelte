...
<div id="content">
  ...
  {:else if $currentPage === 3}
    ...
    <p>
      By sharing your location, you'll see Deeds around you, allowing you to start your journey
      right away.
    </p>
  ...
  {:else if $currentPage === 4 && !isMetamaskInstalled}
    ...
    <p>
      Setup your wallet so you can store your digital goods securely. We use wallets to handle any
      crypto transactions.
    </p>
  ...
  {:else}
    ...
    <p>
      Thank you for finishing the introduction, you are now all set to start your journey with our
      worlds. Have fun!
    </p>
